# Modifications made for integration with QiPRNG
The originals of these files are available [here](https://github.com/dj-on-github/sp800_22_tests). They have been passed through pip's 2to3 tool to make them Python 3 compliant. The main file sp800_22_tests.py has also been otherwise modified.
